...
object PersonList {
    val PERSON_CATEGORY = arrayOf(
        "Solution Architects",
        "Solution Engineers",
        "Customer Success Managers",
    )

    val list: List<Person> by lazy {
        setupPeople()
    }
    private var count: Long = 0

    private fun setupPeople(): List<Person> {
        val title = arrayOf(
    ...
    private fun buildMovieInfo(
        ...
        person.cardImageUrl = cardImageUrl
        person.backgroundImageUrl = backgroundImageUrl
